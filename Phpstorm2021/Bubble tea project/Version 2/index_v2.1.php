...
<head>
    ...
    <meta charset="utf-8">
    <link rel='stylesheet' type='text/css' href='index_v2.1.css'>
</head>
<body>
<header>
    <h1>珍珠岛 Pearl Island</h1>
    <!-- <img alt="Bubble Tea logo" src="logo.jpg"> -->
    <nav>
        <a href="index_v2.1.php">Home</a>
    ...
    <form name='search_bubble_tea_form' id='search_bubble_tea_form' method = 'get' action='drinks_products.php'>
        <table>
                ...
                <td>
                    <select id='drinktypes' name='drinktypes'>
                        ...
                        while ($all_drinktypes_record = mysqli_fetch_assoc($all_drinktypes_result)){
                            echo "<option valie = '". $all_drinktypes_record['ProductTypeID'] . "'>";
            ...
            <tr>
                ...
                <td>
                    <select id="order_bubbleteas" name="order_products">
